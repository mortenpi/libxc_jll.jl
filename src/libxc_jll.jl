...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libxc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d3eb20e7-1f97-5a64-a585-f8e3fb19ea2c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libxc", artifacts_toml) for e in artifacts["libxc"]]
...
if best_platform === nothing
    @debug("Unable to load libxc; unsupported platform $(triplet(platform_key_abi()))")
else
